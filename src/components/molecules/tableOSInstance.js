                ...
                proj === "" ? (
                  <TableBody>
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.project.hypervisor.zone.region.name ===
                          region ? (
                  ...
                  <TableBody>
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.project.hypervisor.zone.region.name === region &&
                          row.project.hypervisor.zone.name === zone ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                                  align={item.contentAlign ?? "left"}
                    ...
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.project.hypervisor.zone.region.name === region &&
                          row.project.hypervisor.zone.name === zone &&
                          row.project.hypervisor.name === hypervisor ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                                  align={item.contentAlign ?? "left"}
