                ...
                proj === "" ? (
                  <TableBody>
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.vmwares.project.hypervisor.zone.region.name ===
                          region ? (
                    ...
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.vmwares.project.hypervisor.zone.region.name ===
                            region &&
                          row.vmwares.project.hypervisor.zone.name === zone ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                                  align={item.contentAlign ?? "left"}
                      ...
                      return (
                        <>
                          {row.vmwares.project.hypervisor.zone.region.name ===
                            region &&
                          row.vmwares.project.hypervisor.zone.name === zone &&
                          row.vmwares.project.hypervisor.name === hypervisor ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                                  align={item.contentAlign ?? "left"}
                  ...
                  <TableBody>
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.vmwares.project.hypervisor.name ===
                          hypervisor ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                  ...
                  <TableBody>
                    {dataSource.map((row, index) => {
                      return (
                        <>
                          {row.vmwares.project.hypervisor.zone.region.name ===
                            region && row.vmwares.project.name === proj ? (
                            <StyledTableRow key={index}>
                              {columns.map((item, i) => (
                                <StyledTableCell
                                  align={item.contentAlign ?? "left"}
