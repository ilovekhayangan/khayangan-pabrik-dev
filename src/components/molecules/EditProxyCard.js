...
import {
  ...
  EDIT_RESERVE_PROXY,
} from "@utils/gql/reverseProxy/constant";

export default function EditProxyCard({ close, data }) {
  ...
  const [editReserveProxy, { data: addData }, loadingSubmit] = useMutation(
    EDIT_RESERVE_PROXY,
    {
