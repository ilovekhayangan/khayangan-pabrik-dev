...
import { CREATE_REGION } from "@utils/gql/region/constant";
...
export default function CreateRegionCard({ close, title }) {
  ...
  const [mutationAddData, addData] = useMutation(CREATE_REGION);
