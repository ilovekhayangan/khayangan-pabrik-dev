...
import { CREATE_ELAS } from "@utils/gql/elastic/constant";

export default function ElasticCard({ close }) {
  ...
  const [addElas, { data: addData }, loadingSubmit] = useMutation(CREATE_ELAS, {
    onCompleted: async () => {
